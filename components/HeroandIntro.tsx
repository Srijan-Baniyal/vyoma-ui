  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-8">
      ...
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">Vyoma UI</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="text-muted-foreground space-y-4">
          <p>
            Vyoma UI is a collection of re-usable components built using{" "}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border p-4">
              ...
              <p>
                Vyoma UI is not a component library. It&apos;s a collection of re-usable components that
      ...
      <div className="space-y-4">
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              No. Vyoma UI is not a component library. It&apos;s a collection of re-usable components
