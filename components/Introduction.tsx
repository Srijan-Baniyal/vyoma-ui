  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-40 w-96 h-96 bg-secondary/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 space-y-16">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Transform your development workflow with our modern component library. 
            Follow these steps to integrate Vyoma UI into your Next.js project.
          </p>
        </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="flex items-start gap-6 mb-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-muted-foreground">Set up a new Next.js project with all the essentials</p>
                  </div>
                </div>
                
                <div className="space-y-6">
                  <p className="text-muted-foreground leading-relaxed">
                    Begin your journey by creating a fresh Next.js project with TypeScript, Tailwind CSS, and ESLint. 
                    This command sets up everything you need for modern React development.
                  </p>

                  <div className="space-y-4">
                    <Snippet text="npx create-next-app@latest my-vyoma-app --typescript --tailwind --eslint" />
                    ...
                    <Card className="p-6 bg-gradient-to-r from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20 border-green-200/50 dark:border-green-800/50">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-green-900 dark:text-green-100 mb-3">Recommended Configuration</h3>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span className="text-green-800 dark:text-green-200">TypeScript for type safety</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span className="text-green-800 dark:text-green-200">Tailwind CSS for styling</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span className="text-green-800 dark:text-green-200">ESLint for code quality</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                              <span className="text-green-800 dark:text-green-200">App Router for modern routing</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="flex items-start gap-6 mb-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-muted-foreground">Add the foundation component library</p>
                  </div>
                </div>

                <div className="space-y-6">
                  <p className="text-muted-foreground leading-relaxed">
                    Vyoma UI builds upon the excellent Shadcn UI foundation. Install it to unlock a comprehensive 
                    collection of beautifully designed, accessible components.
                  </p>

                  <div className="space-y-4">
                    <Snippet text="npx shadcn@latest init" />
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">Skip the questions and use our recommended defaults:</p>
                          </div>
                          <Snippet text="npx shadcn@latest init -d" />
              ...
              <div className="relative p-8 md:p-12">
                <div className="flex items-start gap-6 mb-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-muted-foreground">Customize your component setup</p>
                  </div>
                </div>

                <div className="space-y-6">
                  <p className="text-muted-foreground leading-relaxed">
                    The initialization wizard will guide you through configuring your{" "}
                    <code className="bg-muted px-2 py-1 rounded text-sm font-mono">components.json</code>{" "}
                  ...
                  <Card className="p-6 bg-gradient-to-br from-muted/50 to-muted/20 border-dashed border-2">
                    <div className="space-y-4 font-mono text-sm">
                      <div className="flex items-center gap-4 p-3 rounded bg-background/50">
                        ...
                        <span className="text-muted-foreground">Which style would you like to use?</span>
                        <span className="ml-auto text-primary font-semibold">New York</span>
                      </div>
                      <div className="flex items-center gap-4 p-3 rounded bg-background/50">
                        <span className="text-orange-500 font-semibold">?</span>
                        <span className="text-muted-foreground">Which color would you like to use as base color?</span>
                        <span className="ml-auto text-primary font-semibold">Zinc</span>
                      </div>
                      <div className="flex items-center gap-4 p-3 rounded bg-background/50">
                        <span className="text-orange-500 font-semibold">?</span>
                        <span className="text-muted-foreground">Do you want to use CSS variables for colors?</span>
                        <span className="ml-auto text-primary font-semibold">yes</span>
                      </div>
                    </div>
                  </Card>
                </div>
              ...
              <div className="relative p-8 md:p-12">
                <div className="flex items-start gap-6 mb-8">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg text-green-700 dark:text-green-200">Start creating amazing interfaces</p>
                  </div>
                </div>

                <div className="space-y-8">
                  <p className="text-green-800 dark:text-green-200 leading-relaxed text-lg">
                    Congratulations! Your development environment is now configured with Vyoma UI. 
                    You&apos;re ready to build beautiful, responsive interfaces with our comprehensive component library.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-background/80 backdrop-blur-sm">
                      ...
                      <p className="text-muted-foreground mb-4">Explore our extensive library of pre-built components and patterns.</p>
                      <div className="text-sm text-blue-600 font-medium">50+ Components Available →</div>
                    </Card>
                    ...
                    <Card className="p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-background/80 backdrop-blur-sm">
                      ...
                      <p className="text-muted-foreground mb-4">See real-world implementations and get inspired by our examples.</p>
                      <div className="text-sm text-purple-600 font-medium">Live Examples →</div>
                    </Card>
                  </div>
                </div>
              </div>
        ...
        <div className="text-center py-12">
          <Card className="inline-block p-8 bg-card/50 backdrop-blur-xl border-0 shadow-2xl">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">Join our community and get support from other developers.</p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link href="/docs" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-colors font-medium">
