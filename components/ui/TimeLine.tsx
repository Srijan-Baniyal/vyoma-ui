...
import { CheckCircle, Clock, Sparkles, ArrowRight, Calendar, Tag } from "lucide-react";
...
const TimelineItem = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${selectedScheme.iconBg} ${selectedScheme.iconBorder} border shadow-lg flex items-center justify-center transition-all duration-500 ${selectedScheme.hoverGlow} group-hover:shadow-2xl group-hover:border-opacity-50`}>
          {item.icon ? (
            <motion.div 
      ...
      >
        <Card className={`relative overflow-hidden border-0 shadow-2xl bg-card/80 backdrop-blur-xl group-hover:shadow-3xl transition-all duration-700 ${selectedScheme.hoverGlow}`}>
          <div className={`absolute inset-0 bg-gradient-to-r ${selectedScheme.gradient}`}></div>
          <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${selectedScheme.topBorder}`}></div>
          
          {/* Decorative Elements */}
          <div className={`absolute top-6 right-6 w-24 h-24 bg-gradient-to-br ${selectedScheme.decorative1} rounded-full blur-2xl opacity-50 group-hover:opacity-70 transition-opacity duration-500`} />
          <div className={`absolute bottom-6 left-6 w-20 h-20 bg-gradient-to-br ${selectedScheme.decorative2} rounded-full blur-xl opacity-40 group-hover:opacity-60 transition-opacity duration-500`} />
          ...
          <div className="relative p-8 md:p-10">
            ...
            >
              <div className={`w-10 h-10 rounded-full bg-gradient-to-br ${selectedScheme.iconBg} ${selectedScheme.iconBorder} border flex items-center justify-center shadow-lg`}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 space-y-20">
        ...
        <div className="text-center space-y-8">
          <motion.div
            ...
            animate={isTitleInView ? { opacity: 1, y: 0, scale: 1 } : { opacity: 0, y: 40, scale: 0.95 }}
          ...
          >
            ...
            <motion.div
              ...
              animate={isTitleInView ? { width: "120px", opacity: 1 } : { width: 0, opacity: 0 }}
              ...
              <div className="relative p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">More incredible milestones await on the horizon</p>
                  </div>
                  <motion.div
                    animate={{ x: [0, 5, 0] }}
                    transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
