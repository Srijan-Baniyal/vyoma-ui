    ...
    <div className="max-w-6xl mx-auto p-8 space-y-16 bg-background text-foreground min-h-screen">
      <div className="text-center space-y-6">
        <h1 className="text-5xl font-bold text-primary mb-4 tracking-tight">
          TextDecryption Component
        </h1>
        <p className="text-muted-foreground text-xl max-w-2xl mx-auto leading-relaxed">
          Create stunning text animations with customizable scrambling and
          decryption effects. Perfect for landing pages, loading states, and
      ...
      <section className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Get started with these basic implementations
          </p>
        </div>
